...
hitboxes[1] = {
  fair1 : new hitboxObject(new hitbox(offsets[1].fair1.id0,3.515,12,361,130,10,0,4,0,1,1),new hitbox(offsets[1].fair1.id1,4.687,10,361,130,10,0,4,0,1,1)),
  fair2 : new hitboxObject(new hitbox(offsets[1].fair2.id0,3.515,30,361,80,10,0,3,0,1,1),new hitbox(offsets[1].fair2.id1,4.687,7,361,80,10,0,3,0,1,1)),

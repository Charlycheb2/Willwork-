...
hitboxes[0] = {
  fair : new hitboxObject(new hitbox(offsets[0].fair.id0,3.906,10,270,70,30,0,1,0,1,1),new hitbox(offsets[0].fair.id1,3.906,9,270,70,20,0,1,0,1,1),new hitbox(offsets[0].fair.id2,3.906,9,270,70,20,0,1,0,1,1),new hitbox(offsets[0].fair.id3,3.906,13,270,70,42,0,1,0,1,1)),
  ...
  dair : new hitboxObject(new hitbox(offsets[0].dair.id0,3.515,13,90,70,40,0,1,0,1,1),new hitbox(offsets[0].dair.id1,3.515,10,90,70,40,0,1,0,1,1),new hitbox(offsets[0].dair.id2,3.515,9,361,70,30,0,1,0,1,1),new hitbox(offsets[0].dair.id3,3.515,9,361,70,20,0,1,0,1,1)),

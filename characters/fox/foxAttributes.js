...
hitboxes[2] = {
  ...
  dair : new hitboxObject(new hitbox(offsets[2].dair.id0,5.600,8,270,130,20,100,0,0,1,1),new hitbox(offsets[2].dair.id1,5.600,8,270,130,20,100,0,0,1,1)),
  ...
  downspecial : new hitboxObject(new hitbox(offsets[2].downspecial.id0,4.999,5,90,130,0,100,4,0,1,1)),
